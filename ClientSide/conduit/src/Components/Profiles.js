        ...
        return(
            <>
                ...
                <div className="myArticle">
                    <div className="tab">
                        <h4 onClick={this.handleClick} className={this.state.active === 'My Articles' ? 'active-feed' : '' } >My Articles</h4>
                        <h4 onClick={this.handleClick} className={this.state.active === 'Favorites' ? 'active-feed' : '' } >Favorites</h4>
                    </div>
                    <hr style={{color: '#6BDAED', margin: '0.2px 0 10px 0'}} />
                    <div className="card">
                        {/* {element} */}
                        {
                            active === 'My Articles' ? myElement
                            : active === 'Favorites' ? favElement : ''
                        }
                    </div>
                </div>
